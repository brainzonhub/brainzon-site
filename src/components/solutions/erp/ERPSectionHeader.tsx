...
export function ERPSectionHeader({ eyebrow, title, description, align = "center" }: {
  eyebrow: string;
  title: string;
  description?: string;
  align?: "left" | "center";
  ...
  return (
    <div className={cn("max-w-3xl", align === "center" && "mx-auto text-center")}>
      <p className="mb-4 text-xs font-bold uppercase tracking-[0.24em] text-primary">{eyebrow}</p>
