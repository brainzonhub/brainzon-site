...
import { brainCRMFeatures } from "@/config/crm";
import { cn } from "@/lib/utils";
import { CRMIcon } from "./crm-icons";

export function BrainCRMShowcase() {
  return (
    <section className="relative overflow-hidden border-b border-border bg-background py-20 sm:py-28">
      ...
      <Container className="relative">
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            ...
            <h2 className="text-heading-2 font-bold text-foreground">
              BrainCRM — Enterprise CRM Platform
            </h2>
            <p className="mt-5 text-base leading-8 text-muted-foreground sm:text-lg">
              BrainCRM is Brainzon&apos;s proprietary customer relationship management platform, designed to drive lead conversion, automate marketing pipelines, coordinate support cases, and maintain a complete customer 360 overview.
            </p>
          </div>
          <Link
        ...
        <div className="mt-12 grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {brainCRMFeatures.map((feature, index) => {
              ...
              >
                ...
                <div>
                  <div className="flex items-center gap-4">
                    ...
                    >
                      <CRMIcon name={feature.icon} className="size-5" />
                    </span>
                    <div>
